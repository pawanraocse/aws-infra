...
public class LocalPermissionEvaluator implements PermissionEvaluator {
    ...
    private static final Map<String, Set<String>> ROLE_PERMISSIONS = Map.of(
            "super-admin", Set.of("*:*"), // Full access
            "tenant-admin", Set.of(
                    "entry:*", // Full entry management
                    "user:read", // Can view users
                    "user:invite", // Can invite users
                    "stats:read" // Can view stats
            ),
            "member", Set.of(
                    "entry:read", // Can read entries
                    "entry:create" // Can create entries
            ));
    ...
    public boolean hasPermission(String userId, String tenantId, String resource, String action) {
        ...
        // Check for resource wildcard (e.g., "entry:*")
