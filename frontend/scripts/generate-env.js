...
const config = {
    ...
    cognito: {
        userPoolId: process.env.ANGULAR_APP_COGNITO_POOL_ID || 'us-east-1_PLACEHOLDER',
        userPoolWebClientId: process.env.ANGULAR_APP_COGNITO_CLIENT_ID || 'PLACEHOLDER',
        domain: process.env.ANGULAR_APP_COGNITO_DOMAIN || 'placeholder.auth.us-east-1.amazoncognito.com',
...
console.log(`✅ Environment generated: ${envPath}`);
